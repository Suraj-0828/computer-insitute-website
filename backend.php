...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $transport = (new Swift_SmtpTransport('mail.royalcomputerinstitute.com', 587))
        ->setUsername('noreply@globaleducation4u.com')
        ->setPassword('globaleducation4u@123');
    ...
    $message = (new Swift_Message('Contact Form Query'))
        ->setFrom(['noreply@royalcomputerinstitute.com' => 'Contact Form Query'])
        ->setTo(['royalcomputerbow2019@gmail.com' => 'Contact Form Query'])
